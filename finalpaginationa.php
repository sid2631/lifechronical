...
function demo() {
   ...
   $record=$rows;
    ...
    //anonomus display 
     ...
     $ano=$wpdb->get_results("SELECT * FROM {$wpdb->prefix}usermeta WHERE meta_key='anonymous' AND meta_value='true' ");
   // var_dump($ano);
      $emp=[];
      $user_mx=[];
      $ano_id=[];
