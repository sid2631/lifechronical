    ...
    <div class="symbol">
      ...
      <div class="recentinfo">
        <p class="para1" id="text2">
          <?php echo $max_name ?> <p hidden id="htt" class="para1"> <?php echo "anonomus"; ?></p>
        </p>
        <p class="para2">
    ...
    <div class="symbol">
      ...
      <div class="recentinfo">
        <p class="para1" id="text3">
            <?php echo $fuser_name ?> <p hidden id="httt" class="para1"> <?php echo "anonomus"; ?></p>
        </p>
        <p class="para2">
...
function myFunction() {
  ...
  var htxt=document.getElementById("htt");
  var htxtt=document.getElementById("httt");
  //text
  ...
  if (checkBox.checked == false){
   ...
   if (checkBox.checked == false){
      ...
      htxtt.style.display="none";
    } else {
     texttt.style.display = "none";
     htxtt.style.display="block";
  }
